...
static void test_array_create_no_memory(void) {
    Array *array;
    test_malloc_disable();
    array = array_create();
    test_malloc_enable();
...
static void test_array_create_no_memory_for_elements(void) {
    Array *array;
...
static void test_array_length_of_empty(void) {
    Array *array = array_create();
    test_assert(array_length(array) == 0);
    array_free(array);
}

static void test_array_length_of_null(void) {
    test_assert(array_length(NULL) == 0);
}

static void test_array_insert_adds_null(void) {
    Array *array = array_create();
...
static void test_array_insert_out_of_bounds(void) {
    Array *array = array_create();
    test_assert(array_length(array) == 0);
...
static void test_array_insert_increases_length(void) {
    Array *array = array_create();
    test_assert(array_length(array) == 0);
    array_insert(array, 0, NULL);
...
static void test_array_insert_to_null(void) {
    test_assert(array_insert(NULL, 0, NULL) == 0);
}

static void test_array_insert_at_beginning(void) {
    int a[] = {1, 2, 3};
    Array *array = array_create();
...
static void test_array_insert_at_middle(void) {
    int a[] = {1, 2, 3};
    Array *array = array_create();
    array_insert(array, 0, &a[0]);
...
static void test_array_insert_at_end(void) {
    int a[] = {1, 2, 3};
    Array *array = array_create();
    array_insert(array, 0, &a[0]);
    array_insert(array, 1, &a[1]);
...
static void test_array_remove_from_beginning(void) {
    int a[] = {1, 2, 3};
    Array *array = array_create();
...
static void test_array_remove_from_middle(void) {
    int a[] = {1, 2, 3};
    Array *array = array_create();
    array_push(array, &a[0]);
    array_push(array, &a[1]);
...
static void test_array_remove_from_end(void) {
    int a[] = {1, 2, 3};
    Array *array = array_create();
    array_push(array, &a[0]);
    array_push(array, &a[1]);
...
static void test_array_remove_decreases_length(void) {
    int a[] = {1, 2, 3};
    Array *array = array_create();
    array_push(array, &a[0]);
    array_push(array, &a[1]);
...
static void test_array_remove_from_null(void) {
    test_assert(array_remove(NULL, 0) == NULL);
}

static void test_array_push_adds_to_end(void) {
    int a[] = {1, 2};
    Array *array = array_create();
    array_push(array, &a[0]);
...
static void test_array_push_adds_null(void) {
    Array *array = array_create();
    test_assert(array_length(array) == 0);
...
static void test_array_push_increases_length(void) {
    Array *array = array_create();
    test_assert(array_length(array) == 0);
...
static void test_array_push_to_null(void) {
    test_assert(array_push(NULL, NULL) == 0);
}

static void test_array_capacity_increases(void) {
...
static void test_array_capacity_no_memory(void) {
    int i, initial_capacity;
    Array *array = array_create();
    initial_capacity = array_capacity(array);
    for (i = array_length(array); i < initial_capacity; i++) {
...
static void test_array_capacity_of_empty(void) {
    Array *array = array_create();
    test_assert(array_capacity(array) > 0);
    array_free(array);
}

static void test_array_capacity_of_null(void) {
    test_assert(array_capacity(NULL) == 0);
}

static void test_array_pop_returns_element(void) {
    int a[] = {1, 2};
    Array *array = array_create();
    array_push(array, &a[0]);
    array_push(array, &a[1]);
...
static void test_array_pop_from_empty(void) {
    Array *array = array_create();
    test_assert(array_length(array) == 0);
...
static void test_array_pop_from_null(void) {
...
static void test_array_get_from_empty(void) {
    Array *array = array_create();
...
static void test_array_get_from_null(void) {
...
static void test_array_set_in_empty(void) {
    Array *array = array_create();
    test_assert(array_set(array, 0, NULL) == 0);
    array_free(array);
}

static void test_array_set_in_null(void) {
...
static void test_array_last_of_empty(void) {
    Array *array = array_create();
    test_assert((int*) array_last(array) == NULL);
    array_free(array);
}

static void test_array_last_of_null(void) {
...
static void test_array_sort_null(void) {
    int a[] = {1, 2};
    Array *array = array_create();
    array_push(array, &a[0]);
    array_push(array, &a[1]);
